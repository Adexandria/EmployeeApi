        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostalCode = table.Column<int>(maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatementText = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpenBalances_EarningsLines_EarningsLinesId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OpenBalances_ReimbursementLines_ReimbursementLinesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeAddressId = table.Column<Guid>(nullable: true),
                    BankAccountId = table.Column<Guid>(nullable: true),
                    PayTemplatesId = table.Column<Guid>(nullable: true),
                    OpenBalancesId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Employee", x => x.EmployeeId);
                    table.ForeignKey(
                        name: "FK_Employee_Bank_BankAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenBalances_DeductionLinesId",
                table: "OpenBalances",
                column: "DeductionLinesId");

            migrationBuilder.CreateIndex(
                name: "IX_OpenBalances_EarningsLinesId",
                table: "OpenBalances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenBalances_ReimbursementLinesId",
                table: "OpenBalances",
                column: "ReimbursementLinesId");

            migrationBuilder.CreateIndex(
                name: "IX_OpenBalances_SuperLinesId",
                table: "OpenBalances",
                column: "SuperLinesId");
